using MetroFramework.Components; //Делаем графику
using System;
...
using System.IO; //подключаем библиотеку для использования в дисковом пространстве
...
namespace Может_быть_нормальный_файловый_менеджер
{
    public partial class Form1 : MetroFramework.Forms.MetroForm
    {
        ...
        {
            MetroStyleManager metroStyleManager1 = null; //Поднимаем графику
            this.StyleManager = metroStyleManager1;
            notifyIcon1.BalloonTipTitle = "File Manager"; // отображение для уведомлений
            notifyIcon1.BalloonTipText = "File Manager has been worked..."; // отображение для уведомлений
            notifyIcon1.Text = "Virus Detected"; // отображение для уведомлений
        }
